...
if __name__ == "__main__":
    ...
    final_balances, lowest_balance = multi_process_multi_player_simulation(num_rounds=num_of_rounds,num_of_players=num_of_players
                                                                           ,num_simulations=num_of_sim,num_decks=num_decks,
