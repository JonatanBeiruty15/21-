...
def plot_with_gaussian(data, title, filename, x_label, y_label):
...
def game_simulation_one_player(num_of_rounds = 1000,num_decks=7):
    ...
    shoe.reset_shoe
    # print(f"Player's balance after {num_of_rounds} rounds is: {player.balance}")
    # print(f'lowest balance was:   {lowest_balance}')
...
if __name__ == "__main__":
    run_multiple_simulations(num_simulations=1000,num_rounds= 150, num_decks=7)